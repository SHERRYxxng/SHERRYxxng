...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | SHERRY")[0];
}
...
function createtime1() {
  ...
  var ascll = [
    ...
    SSSSSSSSSSSSSSS HHHHHHHHH     HHHHHHHHHEEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRR   RRRRRRRRRRRRRRRRR   YYYYYYY       YYYYYYY
    SS:::::::::::::::SH:::::::H     H:::::::HE::::::::::::::::::::ER::::::::::::::::R  R::::::::::::::::R  Y:::::Y       Y:::::Y
   S:::::SSSSSS::::::SH:::::::H     H:::::::HE::::::::::::::::::::ER::::::RRRRRR:::::R R::::::RRRRRR:::::R Y:::::Y       Y:::::Y
   S:::::S     SSSSSSSHH::::::H     H::::::HHEE::::::EEEEEEEEE::::ERR:::::R     R:::::RRR:::::R     R:::::RY::::::Y     Y::::::Y
   S:::::S              H:::::H     H:::::H    E:::::E       EEEEEE  R::::R     R:::::R  R::::R     R:::::RYYY:::::Y   Y:::::YYY
   S:::::S              H:::::H     H:::::H    E:::::E               R::::R     R:::::R  R::::R     R:::::R   Y:::::Y Y:::::Y   
    S::::SSSS           H::::::HHHHH::::::H    E::::::EEEEEEEEEE     R::::RRRRRR:::::R   R::::RRRRRR:::::R     Y:::::Y:::::Y    
     SS::::::SSSSS      H:::::::::::::::::H    E:::::::::::::::E     R:::::::::::::RR    R:::::::::::::RR       Y:::::::::Y     
       SSS::::::::SS    H:::::::::::::::::H    E:::::::::::::::E     R::::RRRRRR:::::R   R::::RRRRRR:::::R       Y:::::::Y      
          SSSSSS::::S   H::::::HHHHH::::::H    E::::::EEEEEEEEEE     R::::R     R:::::R  R::::R     R:::::R       Y:::::Y       
               S:::::S  H:::::H     H:::::H    E:::::E               R::::R     R:::::R  R::::R     R:::::R       Y:::::Y       
               S:::::S  H:::::H     H:::::H    E:::::E       EEEEEE  R::::R     R:::::R  R::::R     R:::::R       Y:::::Y       
   SSSSSSS     S:::::SHH::::::H     H::::::HHEE::::::EEEEEEEE:::::ERR:::::R     R:::::RRR:::::R     R:::::R       Y:::::Y       
   S::::::SSSSSS:::::SH:::::::H     H:::::::HE::::::::::::::::::::ER::::::R     R:::::RR::::::R     R:::::R    YYYY:::::YYYY    
   S:::::::::::::::SS H:::::::H     H:::::::HE::::::::::::::::::::ER::::::R     R:::::RR::::::R     R:::::R    Y:::::::::::Y    
    SSSSSSSSSSSSSSS   HHHHHHHHH     HHHHHHHHHEEEEEEEEEEEEEEEEEEEEEERRRRRRRR     RRRRRRRRRRRRRRR     RRRRRRR    YYYYYYYYYYYYY    
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by SHERRY %c 你正在访问SHERRYの小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| SHERRY") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('SHERRY的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  var start = new Date("27/04/2023 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("27/04/2023 00:00:00");
